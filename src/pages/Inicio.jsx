    ...
    return (
        <div className='container-publicidad'>
            <div id="sect_video" className="sect_video">
                <video className="video_1" src="./src/multimedia/intro3.mp4" autoplay="true" muted="true" loop="true"
                    poster=""></video>
            </div>
                ...
                <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img src="./src/img/carrusel-1/oferta1.png" className="d-block w-100" alt="..." />
                        </div>
                        <div className="carousel-item">
                            <img src="./src/img/carrusel-1/oferta2.png" className="d-block w-100" alt="..." />
                        </div>
                        <div className="carousel-item">
                            <img src="./src/img/carrusel-1/oferta3.png" className="d-block w-100" alt="..." />
                        </div>
                    </div>
                </div>
            </div>
